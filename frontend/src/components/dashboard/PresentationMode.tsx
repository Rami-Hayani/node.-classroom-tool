...
export default function PresentationMode({ lectureId, deck, slides, availableDecks, concepts, currentSlideIndex, onSlideChange, onDeckSelect, onUploadFile, onPollActivated, onClose }: PresentationModeProps) {
  const fileRef = useRef<HTMLInputElement>(null);
  const [selectedConceptId, setSelectedConceptId] = useState("");
  const [poll, setPoll] = useState<{ pollId: string; question: string; conceptLabel: string; status: "preview" | "active" } | null>(null);
